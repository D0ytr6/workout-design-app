...
@Database(entities = [WorkoutTableModel::class, ExerciseTableModel::class, WorkoutDataTableModel::class], version = 1, exportSchema = false)
abstract class WorkoutDatabase : RoomDatabase() {
    ...
    companion object{
        ...
        fun getWorkoutDb(context: Context) : WorkoutDatabase{
            ...
            synchronized(this) {
                INSTANCE = Room.databaseBuilder(context, WorkoutDatabase::class.java, "workouts.db").build()
                return INSTANCE!!
            }
