...
class StatisticLineStyle (
    ...
    fun styleChart(lineChart: LineChart, xLabel: List<String>, axMin: Float, axMax: Float): LineChart {
...
//            isEnabled = false
                ...
                typeface = ResourcesCompat.getFont(context, R.font.sourcesans3regular)
